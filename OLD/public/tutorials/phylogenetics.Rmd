...
comments: false
date: 2015-07-28 03:42:22+00:00
layout: page
link: http://www.brianomeara.info/tutorials/phylogenetics/
slug: phylogenetics
title: Phylogenetics
wordpress_id: 72
---
...
Made Easy](http://www.sinauer.com/Titles/Text/3115.html)_ by Barry Hall, chapters 11 and 12 of the somewhat
dated (1996) _[Molecular
Systematics, 2nd Edition](http://www.sinauer.com/Titles/frhillis.htm)_, edited by David Hillis, Craig Moritz,
and Barbara Mable, and the recently updated [Molecular Systematics](http://www.bioinf.org/molsys/index.html)
website. A great new resource is Joe Felsenstein's new book _[Inferring Phylogenies](http://www.sinauer.com/detail.php?id=1775)_.
You may also check my page of [books for phylogenetics](http://www.brianomeara.info/books.html).
PAUP also has a [quick start
tutorial](http://paup.csit.fsu.edu/downl.html#Anchor-58521) on its [web page](http://paup.csit.fsu.edu/)
as well as a useful [discussion
group](http://pauptech.si.edu/%7Epaupforum/) for asking questions. Useful software links can be found on
my [general links](/links.html) page. Please direct any
comments about this page to [me](mailto:bcomeara@ucdavis.edu).
...
NEXUS file preparation
  ...
  1. Open the NEXUS file with [MacClade](http://phylogeny.arizona.edu/macclade/macclade.html)
4.03 or higher.
...
numbers.
  ...
  18. Open PAUP 4.0b8 or higher. PAUP often has updates, so check its [website](http://paup.csit.fsu.edu/) to make sure you are
using a recent version. Also check for [bug reports](http://paup.csit.fsu.edu/problems.html).
...
document, available from the [downloads](http://paup.csit.fsu.edu/downl.html) section of
its [website](http://paup.csit.fsu.edu/), is invaluable in
...
moderate numbers of taxa: finding the best tree is generally an [NP-hard ](http://en.wikipedia.org/wiki/NP-hard)problem.
...
and Paul Lewis have written a program, called [PaupRat](http://viceroy.eeb.uconn.edu/paupratweb/pauprat.htm),
...
For simple decay indices, [MacClade](http://www.macclade.org/) can generate a batch
file. Go to the tree window, then go to the sigma (![](../icons/sigma.gif)) menu -> "Decay Index Paup
File...". For partitioned Bremer support, we use [TreeRot](http://mightyduck.bu.edu/TreeRot/index.html) (see
...
We generally use David Posada's program [ModelTest](http://bioag.byu.edu/zoology/crandall_lab/modeltest.htm)
...
web site](http://www.fon.hum.uva.nl/Service/Statistics/ChiSquare_distribution.html) to compute the p-value. Significant p-values mean that the
...
used, both implemented in Sanderson's [r8s](http://ginger.ucdavis.edu/r8s/) program. The first
...
computers to run r8s. First, [Phylip](http://evolution.genetics.washington.edu/phylip.html)'s
...
program). I use [MrBayes](http://brahms.biology.rochester.edu/software.html)
for this. Good introductions to the proper use of MrBayes (such as
diagnosing convergence) can be found at Frederick Ronquist's [site](http://www.csit.fsu.edu/%7Eronquist/mrbayes/). 
