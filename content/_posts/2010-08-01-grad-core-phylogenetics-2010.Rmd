...
homology
**Slides**: [pdf](http://brianomeara.info/sites/default/files/2010ix29_UTKEEB_Core_Phylogenetics1_V02.pdf), [keynote](http://brianomeara.info/sites/default/files/2010ix29_UTKEEB_Core_Phylogenetics1_V02.key), [mov](http://brianomeara.info/sites/default/files/2010ix29_UTKEEB_Core_Phylogenetics1_V02.mov) (QuickTime movie)
**R assignment**:
By the start of class Wednesday, please:
1) Install R on a computer you can access (you don't need to bring it in, so a desktop at home is fine). You can get an installer from [http://cran.r-project.org/](http://cran.r-project.org/) .
2) Read this web page: [http://bodegaphylo.wikispot.org/Phylogenetics_and_Comparative_Methods_in_R](http://bodegaphylo.wikispot.org/Phylogenetics_and_Comparative_Methods_in_R)
3) Read and do the exercises (aka "type ~8 lines") from this web page: [http://bodegaphylo.wikispot.org/I._Getting_Started_with_R](http://bodegaphylo.wikispot.org/I._Getting_Started_with_R) . Do the task view route (it's easier).
...
**Slides**: [pdf](http://brianomeara.info/sites/default/files/2010x1_UTKEEB_Core_Phylogenetics2_V01.pdf), [keynote](http://brianomeara.info/sites/default/files/2010x1_UTKEEB_Core_Phylogenetics2_V01.key), [mov](http://brianomeara.info/sites/default/files/2010x1_UTKEEB_Core_Phylogenetics2_V01.mov) (QuickTime movie)
...
![](http://brianomeara.info/sites/default/files/PriorPosterior.png) [R code for animation to make image](http://brianomeara.info/sites/default/files/animateMLvsBayes.R)
  
**Slides**: [pdf](http://brianomeara.info/sites/default/files/2010x04_UTKEEB_Core_Phylogenetics3_V01.pdf), [keynote](http://brianomeara.info/sites/default/files/2010x04_UTKEEB_Core_Phylogenetics3_V01.key), [mov](http://brianomeara.info/sites/default/files/2010x04_UTKEEB_Core_Phylogenetics3_V01.mov) (QuickTime movie)
  
**R assignment**: Do your own tree search
  

The next assignment should be pretty fun. You are going to write a heuristic search algorithm for getting the maximum parsimony tree in R after downloading a set of GenBank sequences, also within R. I've sketched out a lot of the code -- the main tricky bit should be figuring out how to store the best tree as you go and learning how to use an if() function. Comments in ALL CAPS are the sections you should focus on for changing. You're encouraged to play with this assignment: maybe you want to plot the scores as you search, maybe you want to try different search strategies, etc. Feel free to email me for help or talk to your cohort-mates (remember you can use the blackboard forum, too). R code below and [attached](http://brianomeara.info/sites/default/files/treesearch.R).
...
**Slides**: [pdf](http://brianomeara.info/sites/default/files/2010x06_UTKEEB_Core_Phylogenetics4_V01.pdf), [keynote](http://brianomeara.info/sites/default/files/2010x06_UTKEEB_Core_Phylogenetics4_V01.key), [mov](http://brianomeara.info/sites/default/files/2010x06_UTKEEB_Core_Phylogenetics4_V01.mov) (QuickTime movie)
...
**Slides**: [pdf](http://brianomeara.info/sites/default/files/2010x11_UTKEEB_Core_Phylogenetics5_V01.pdf), [keynote](http://brianomeara.info/sites/default/files/2010x11_UTKEEB_Core_Phylogenetics5_V01.key), [mov](http://brianomeara.info/sites/default/files/2010x11_UTKEEB_Core_Phylogenetics5_V01.mov) (QuickTime movie)
