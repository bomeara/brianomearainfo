...
hhs_capacity_tn_focal_cities %<>% group_by(city, DATE) %>% mutate(number_unoccupied_adult_hospital_inpatient_beds = sum(number_unoccupied_adult_hospital_inpatient_beds), number_unoccupied_adult_hospital_ICU_beds = sum(number_unoccupied_adult_hospital_ICU_beds))
...
hhs_plot2b <- ggplot(hhs_capacity_tn_focal_cities, aes(x=DATE, y=number_unoccupied_adult_hospital_inpatient_beds, group=city, fill=city)) + geom_area() + ylab("Number of unoccupied adult inpatient beds total") + xlab("Start of collection week") + theme(legend.position="bottom") + theme(legend.text=element_text(size=8))
print(hhs_plot2b)
...
hhs_plot4b <- ggplot(hhs_capacity_tn_focal_cities, aes(x=DATE, y=number_unoccupied_adult_hospital_ICU_beds, group=city, fill=city)) + geom_area() + ylab("Number of unoccupied adult ICU beds total") + xlab("Start of collection week") + theme(legend.position="bottom") + theme(legend.text=element_text(size=8))
print(hhs_plot4b)
