...
UT's testing on some days has 100% positivity rate, but that is partially due to low sample size (as well as the underlying incidence rate and bias in who gets tested). For ease of visualization, the positivity scale is cut off at 50%, but points above this are used to help inform the smoothed trend lines.
