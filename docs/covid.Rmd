...
UT is holding various events at the start of the school year. These are images from some of those events. 

![UT Success Academy with no apparent masking](Aug12_2021.png)

![UT Band at Neyland Stadium (I'm not sure if this space is indoors or outdoors). No masking](Aug13_2021.png)

![UT Silent Disco with no apparent masking](Aug14_2021.png)
