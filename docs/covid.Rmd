...
<b>Around Sept. 4, the reported number of active cases dramatically dropped: Knox calculations of what constituted an active case changed from being based on recoveries to just a certain number of days after a positive test. So do not compare numbers across that date boundary.</b>
