...
* <a href="https://covidactnow.org/us/tn?s=49762">Covid ActNow aggregate of information, including contact tracing, infection rate, and more</a>
...
tn_new_hospitalization <- ggplot(tn_daily_aggregate[!is.na(tn_daily_aggregate$new_hosp),], aes(x=DATE, y=new_hosp)) + geom_smooth() + geom_point() + ylab("Number of new covid hospitalizations in TN") + xlab("Date") + ylim(0,NA)
...
<iframe src="https://covidactnow.org/us/tn?s=49762" width=800 height=600></iframe>

<iframe src="https://covidactnow.org/us/tn/county/knox_county_loudon_county?s=49762" width=800 height=600></iframe>
