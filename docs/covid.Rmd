...
hhs_plot2b <- ggplot(hhs_capacity_tn_focal, aes(x=DATE, y=number_unoccupied_adult_hospital_inpatient_beds, group=hospital_name, fill=hospital_name)) + geom_area() + ylab("Number of unoccupied adult inpatient beds total") + xlab("Start of collection week")
print(hhs_plot2b)
...
hhs_plot4b <- ggplot(hhs_capacity_tn_focal, aes(x=DATE, y=number_unoccupied_adult_hospital_ICU_beds, group=hospital_name, fill=hospital_name)) + geom_area() + ylab("Number of unoccupied adult ICU beds total") + xlab("Start of collection week")
print(hhs_plot4b)
