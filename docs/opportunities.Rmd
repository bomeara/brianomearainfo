...
Standard lab policy is that you should reach out to [current and past lab members](http://brianomeara.info/personnel.html) for feedback on what it's like here, and **never** tell me what they say, positive or negative. That way they know they can be frank with you.
...
You might look at [lab guidelines](http://brianomeara.info/guidelines.html) to get a sense of how the lab works. Materials I created for [promotion](http://brianomeara.info/promotion.html), especially the promotion packet itself ([PDF](http://brianomeara.info/files/OMearaPromotionPacket.pdf)) may give you a good summary of where my teaching, research, and service have been and are going. For what you might learn here, [learning objectives](http://brianomeara.info/learningobjectives.html) can be helpful.
...
* Matt Might has a good [visual guide](http://matt.might.net/articles/phd-school-in-pictures/) of what it means to get a PhD (though Masters is similar; in our field, it's ~1/3 of the research effort, but still represents a contribution to knowledge).
