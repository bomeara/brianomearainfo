...
comments: false
layout: page
link: https://www.brianomeara.info/research/
slug: research
title: Research
---

Note you can see a feed of recent articles at [Google Scholar](https://scholar.google.com/citations?sortby=pubdate&hl=en&user=vpjEkQwAAAAJ&view_op=list_works); this updates more quickly than this page does. In the lag time between submission and publication, you can see my manuscripts on [bioRxiv](https://biorxiv.org/search/author1%3ABrian%2BO%2527Meara%2B).
...
O'Meara, B. C. 2012a. CRAN Task View: Phylogenetics. Version 2012-02-02, URL https://cran.r-project.org/web/views/Phylogenetics.html.
