...
Scheduling classes can be difficult given limited room availability and various schedule conflicts and constraints. I made a [tool](https://brianomeara.shinyapps.io/EEB_Teaching_Schedule/) for our department to schedule classes for the upcoming semester; others may use it, too.
